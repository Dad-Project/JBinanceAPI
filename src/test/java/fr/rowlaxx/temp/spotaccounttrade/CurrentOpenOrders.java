...
public class CurrentOpenOrders extends JSavONObject {
	private static final long serialVersionUID = -3226621889050478277L;
	...
	//Constructeurs
	public CurrentOpenOrders(JSONObject json) {
		super(json);
	}
