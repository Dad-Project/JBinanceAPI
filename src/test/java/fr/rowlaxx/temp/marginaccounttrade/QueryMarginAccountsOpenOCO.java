...
import fr.rowlaxx.temp.marginaccounttrade.querymarginaccountsopenoco.Orders;

import java.util.List;

import org.json.JSONObject;

public class QueryMarginAccountsOpenOCO extends JSavONObject {
	private static final long serialVersionUID = -1595146724430477040L;
	...
	//Constructeurs
	public QueryMarginAccountsOpenOCO(JSONObject json) {
		super(json);
	}
