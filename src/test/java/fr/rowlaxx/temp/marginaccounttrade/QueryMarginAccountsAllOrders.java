...
public class QueryMarginAccountsAllOrders extends JSavONObject {
	private static final long serialVersionUID = -2034786264173610465L;
	...
	//Constructeurs
	public QueryMarginAccountsAllOrders(JSONObject json) {
		super(json);
	}
