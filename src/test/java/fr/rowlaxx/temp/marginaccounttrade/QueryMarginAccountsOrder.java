...
public class QueryMarginAccountsOrder extends JSavONObject {
	private static final long serialVersionUID = 6540113802767857985L;
	...
	//Constructeurs
	public QueryMarginAccountsOrder(JSONObject json) {
		super(json);
	}
