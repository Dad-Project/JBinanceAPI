...
public interface C2CAPI extends Api.Https, Api.Spot {
	...
	public List<C2CTradeRecord> getC2CTradeHistory(OrderSide tradeType, Long startTimestamp, Long endTimestamp, Integer page, Integer rows);

	default List<C2CTradeRecord> getCC2CTradeHistory(OrderSide tradeType, Integer page, Integer rows){
	...
	default List<C2CTradeRecord> getCC2CBuyHistory(Long start, Long end, Integer page, Integer rows){
		return getC2CTradeHistory(OrderSide.BUY, start, end, page, rows);
	}
	
	default List<C2CTradeRecord> getCC2CBuyHistory(Integer page, Integer rows){
		return getC2CTradeHistory(OrderSide.BUY, null, null, page, rows);
	}
	
	default List<C2CTradeRecord> getCC2CSellHistory(Long start, Long end, Integer page, Integer rows){
		return getC2CTradeHistory(OrderSide.SELL, start, end, page, rows);
	}
	
	default List<C2CTradeRecord> getCC2CSellHistory(Integer page, Integer rows){
		return getC2CTradeHistory(OrderSide.SELL, null, null, page, rows);
	}
}