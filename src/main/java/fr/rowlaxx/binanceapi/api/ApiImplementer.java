...
public class ApiImplementer {
	...
	static <T extends Api> T implementz(Class<T> clazz, final BinanceClientImpl client) {
	...
	private static Object invokeEndpoint(BinanceClientImpl client, Object proxy, Method method, Object[] args) throws IOException {
